<script>
// import TinySearchBox from '../../search-box/dist/vue2/es/index.es.js';
import TinySearchBox from '../../search-box/src/index'
...
<template>
  <div class="wrapper">
    <tiny-search-box v-model="tags" :items="dataSource"> </tiny-search-box>
  </div>
</template>
<style scoped>
.wrapper {
